...
public class FormationEntity {
  ...
  public FormationEntity(Formation formation) {
    ...
    for (Unit unit : formation.getUnits()) {
      FormationUnitTable formationUnitTable =
          new FormationUnitTable(unit, this);
  ...
  public void
  setFormationUnitTable(Set<FormationUnitTable> formationUnitTable) {
  ...
  public int getAmountUnits() { return formationUnitTable.size(); }
