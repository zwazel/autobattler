...
public class FormationUnitTable {
  ...
  @ManyToOne private UnitModel unitModel;
  ...
  public Vector getUnitPosition() { return new Vector(positionX, positionY); }
  ...
  public String toString() {
    return "FormationUnitTable{"
        + "id=" + id + ", unitModel=" + unitModel +
        ", unitPriority=" + unitPriority + ", positionX=" + positionX +
        ", positionY=" + positionY + '}';
  }

  public UnitModel getUnitModel() { return unitModel; }

  public void setUnitModel(UnitModel unitModel) { this.unitModel = unitModel; }

  public int getUnitPriority() { return unitPriority; }
