...
public class User {
  ...
  @NotNull
  @Size(min = UserLoginInfos.MIN_USERNAME_LENGTH,
        max = UserLoginInfos.MAX_USERNAME_LENGTH)
  @Column(length = UserLoginInfos.MAX_USERNAME_LENGTH, unique = true)
  private String username;

  @NotNull
  @Size(min = UserLoginInfos.MIN_PASSWORD_LENGTH,
        max = UserLoginInfos.MAX_PASSWORD_LENGTH)
  ...
  public void addUnit(UnitModel unit) { units.add(unit); }
