...
public class Vector {
  ...
  public static Vector getRandomDirection(boolean diagonalAllowed) {
    ...
    int n =
        rand.nextInt((diagonalAllowed) ? Vector.DIRECTION.values().length
                                       : DIRECTION.DOWN.getNonDiagonalAmount());
  ...
  public void add(int num) { add(new Vector(num, num)); }
  ...
  public Vector subtract(int num) { return subtract(new Vector(num, num)); }
  ...
  public Long toNumberId() { return Long.valueOf(this.x + "" + this.y); }
  ...
  public enum DIRECTION {
    ...
    DIRECTION(int x, int y) { this.direction = new Vector(x, y); }

    public Vector getDirection() { return direction; }

    public int getNonDiagonalAmount() { return 4; }
  }
}
