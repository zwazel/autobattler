...
public class Grid {
  ...
  public Grid(int x, int y) { this(new Vector(x, y)); }
  ...
  public void updateOccupiedGrid(Unit unit) {
    gridCells[unit.getGridPosition().getX()][unit.getGridPosition().getY()]
        .setCurrentObstacle(unit);
  }
  ...
  public Vector getGridSize() { return new Vector(width, height); }

  @Override
  public String toString() {
    return "Grid{"
        + "gridCells=" + Arrays.deepToString(gridCells) + ", width=" + width +
        ", height=" + height + '}';
  }
}
